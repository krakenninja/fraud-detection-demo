...
package com.ververica.field.dynamicrules.impl;
...
import com.ververica.field.dynamicrules.constants.Application;
...
@Component
@Profile(
    Application.PROFILE_LOCAL_DEPLOYMENT
)
@Accessors(
    chain = true,
    fluent = false
...
@NoArgsConstructor
@Slf4j
public class RulesEvaluatorLocal implements RulesEvaluator {
